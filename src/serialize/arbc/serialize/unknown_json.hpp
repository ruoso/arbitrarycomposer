...
ARBC_API bool names_key(std::span<const std::string_view> known, std::string_view key);

// `obj - known`: the keys present in `obj` that the core does not name at this tier.
// A non-object `obj` yields an empty object.
ARBC_API nlohmann::json unknown_residual(const nlohmann::json& obj,
...
ARBC_API nlohmann::json unknown_residual_at(const nlohmann::json& obj, std::string_view key,
                                            std::span<const std::string_view> known);
...
ARBC_API nlohmann::json unknown_residual_diff(const nlohmann::json& input,
...
ARBC_API UnknownFields to_unknown_fields(const nlohmann::json& residual);
...
// merge recurses.
ARBC_API void merge_unknown(nlohmann::json& known, const nlohmann::json& stash);
...
ARBC_API void merge_unknown_fields(nlohmann::json& known, const UnknownFields* fields);
